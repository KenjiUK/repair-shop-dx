...
- [ ] すべてのアイコンに適切なサイズを設定
- [ ] すべてのアイコンに`shrink-0`を設定
- [ ] アイコンカラーを統一（`text-slate-500`など）
...
- [ ] カードタイトル: `text-lg font-semibold`
- [ ] 第1階層: `text-lg font-semibold`
- [ ] 第2階層: `text-base font-medium` または `text-sm font-medium`
- [ ] バッジ: `text-xs font-medium`
...
- [ ] ステータスバッジ: `text-xs px-2.5 py-0.5 rounded-full`
- [ ] 入庫区分バッジ: `text-xs px-2.5 py-1 rounded-full`
- [ ] バッジ内アイコン: `h-3.5 w-3.5`
- [ ] バッジ内テキスト: `whitespace-nowrap`
- [ ] バッジ全体: `shrink-0`
...
- [ ] カード間: `space-y-4`
- [ ] カード内要素: `space-y-1.5`
- [ ] Gap: モバイル対応（`gap-1.5 sm:gap-2`など）

### 4-5. モバイル対応

- [ ] テキスト折り返し: `break-words`
- [ ] バッジ: `whitespace-nowrap`と`shrink-0`
- [ ] レスポンシブ表示: 適切な設定
...
- [ ] カード・コンポーネントの統一（フェーズ2）
- [ ] ボタン・アクション要素の統一（フェーズ3）
- [ ] モバイル対応の最終確認（フェーズ4）
