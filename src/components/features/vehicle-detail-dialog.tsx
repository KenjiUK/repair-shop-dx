...
export function VehicleDetailDialog({
  ...
  useEffect(() => {
    if (!vehicleMaster || !courtesyCars.length) {
      setCourtesyCar(null);
      return;
    }
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <p className="text-xs text-slate-500 mb-1">車両ID</p>
                  ...
                  <div className="col-span-2">
                    <p className="text-xs text-slate-500 mb-1">型式</p>
                    <p className="text-sm font-medium text-slate-900">
                      {vehicleMaster.型式}
                    </p>
                  </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="col-span-2">
                      <p className="text-xs text-slate-500 mb-1">ナンバープレート</p>
                      <p className="text-sm font-medium text-slate-900">
                    ...
                    {courtesyCar.jobId && (
                      <div>
                        <p className="text-xs text-slate-500 mb-1">紐付け中の案件ID</p>
                        <p className="text-sm font-medium text-slate-900">
                          {courtesyCar.jobId}
                        </p>
                      </div>
                    ...
                    {courtesyCar.rentedAt && (
                      <div>
                        <p className="text-xs text-slate-500 mb-1">貸出開始日時</p>
                        <p className="text-sm font-medium text-slate-900">
