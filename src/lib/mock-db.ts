...
export const jobs: ZohoJob[] = [
  ...
  // === 車検: Phase 1 - 入庫済み（複合業務：車検+板金修理） ===
  {
    ...
    vehicle: { id: "veh-002", name: "メルセデス・ベンツ Eクラス / 港 500 さ 5678" } as ZohoLookup,
    serviceKind: "車検" as ServiceKind,
    field_service_kinds: ["車検", "板金・塗装"] as ServiceKind[],
    field: null,
    workOrder: null,
    field7: "車検希望。ブレーキの音が気になる。また、左ドアにへこみがあるので板金修理も希望。",
    details: "車検希望。ブレーキの音が気になる。また、左ドアにへこみがあるので板金修理も希望。",
    field10: 52000,
    mileage: 52000,
    field13: null,
    approvedWorkItems: null,
    ...
    field_work_orders: serializeWorkOrdersForZoho([
      {
        id: "wo-test-shaken-02-inspection",
        ...
        diagnosis: {
          items: [
            { id: "inspection-1", name: "エンジンルーム", category: "エンジンルーム", status: "green", comment: null, evidencePhotoUrls: [], evidenceVideoUrl: null },
            { id: "inspection-2", name: "室内", category: "室内", status: "green", comment: null, evidencePhotoUrls: [], evidenceVideoUrl: null },
            { id: "inspection-3", name: "足回り", category: "足回り", status: "yellow", comment: "ブレーキパッド残量確認要", evidencePhotoUrls: [], evidenceVideoUrl: null },
            { id: "inspection-4", name: "下回り", category: "下回り", status: "green", comment: null, evidencePhotoUrls: [], evidenceVideoUrl: null },
            { id: "inspection-5", name: "外装", category: "外装", status: "green", comment: null, evidencePhotoUrls: [], evidenceVideoUrl: null },
          ],
          photos: [],
      ...
      {
        id: "wo-test-shaken-02-bodypaint",
        jobId: "test-shaken-02",
        serviceKind: "板金・塗装" as ServiceKind,
        status: "外注調整中" as WorkOrderStatus,
        diagnosis: {
          items: [
            { id: "bodypaint-1", name: "左ドア", category: "外装", status: "red", comment: "左ドアにへこみあり。板金・塗装が必要。", evidencePhotoUrls: [], evidenceVideoUrl: null },
          ],
          photos: [],
          mileage: 52000,
        },
        ...
        vendor: {
          name: "横浜板金工業",
          contact: "045-1234-5678",
          notes: "左ドアの板金・塗装を依頼。見積もり待ち。",
  ...
  // === 複合業務サンプル: 車検 + 板金修理（外注連携テスト用） ===
  {
    id: "test-composite-01",
    field22: todayISO.replace(/T.*/, "T09:00:00+09:00"),
    arrivalDateTime: todayISO.replace(/T.*/, "T09:00:00+09:00"),
    field5: "診断中",
    stage: "診断中",
    ...
    details: "車検と同時に左フェンダーの板金修理も希望。",
    field10: 85000,
    mileage: 85000,
    field13: null,
    approvedWorkItems: null,
    field19: "https://drive.google.com/drive/folders/test-composite-01",
    customerFolderUrl: "https://drive.google.com/drive/folders/test-composite-01",
    ID_BookingId: "booking-composite-01",
    bookingId: "booking-composite-01",
    field12: null,
    attachments: null,
    tagId: "01",
    field_service_kinds: ["車検", "板金・塗装"] as ServiceKind[],
    ...
    field_work_orders: serializeWorkOrdersForZoho([
      {
        id: "wo-composite-01-inspection",
        jobId: "test-composite-01",
        serviceKind: "車検" as ServiceKind,
        status: "診断中" as WorkOrderStatus,
        diagnosis: {
          items: [
      ...
      {
        id: "wo-composite-01-bodypaint",
        jobId: "test-composite-01",
        serviceKind: "板金・塗装" as ServiceKind,
        status: "外注調整中" as WorkOrderStatus,
        diagnosis: {
          items: [
            { id: "bodypaint-1", name: "左フェンダー", category: "外装", status: "red", comment: "左フェンダーに大きなへこみあり。板金・塗装が必要。", evidencePhotoUrls: [], evidenceVideoUrl: null },
          ],
          photos: [],
          mileage: 85000,
        },
